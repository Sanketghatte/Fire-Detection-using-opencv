...
def send_mail_function(): 
    ...
    recipientmail = "wolfsanku@gmail.com" # recipients mail
    ...
    try:
        ...
        server.login("sanketghatte23@gmail.com", 'sg342004') 
        # recipients mail with mail message
        server.sendmail('wolfsanku@gmail.com', recipientmail, "Warning fire accident has been reported") 
